...
@Data
@NoArgsConstructor
public class OBEPQuery extends SPARQLQuery {
    ...
    public OBEPQuery(Prologue prologue) {
        super(prologue);
    }


    @Override
    public OBEPQuery addElement(ElementGroup sub) {
        setQueryPattern(sub);
    ...
    public OBEPQuery addEventDecl(EventDecl ed) {
    ...
    private OBEPQuery addEventCalculusDecl(EventCalculusDecl ed) {
    ...
    private OBEPQuery _addMQLVar(VarExprList varlist, Var v) {
        if (varlist == null)
    ...
    public OBEPQuery setOBEPQueryStar() {
